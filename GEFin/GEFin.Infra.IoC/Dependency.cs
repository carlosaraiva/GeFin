...
using GEFin.Application;

namespace GEFin.Infra.Ioc
{
    public static class Dependency
    {
        ...
        {
            return serviceCollection.AddDbContext<DataContext>(x => x.UseSqlServer(configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("GEFin.Api")));
        }
